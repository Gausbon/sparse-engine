...
void arm_nn_convolve_s8_single_sparse_CHW ( const cmsis_nn_conv_params *conv_params,
...
void arm_nn_convolve_s8_double_sparse_CHW ( const cmsis_nn_conv_params *conv_params,
                                    const q7_t *input_data,
                                    const int32_t input_x,
                                    const int32_t input_y,
                                    const int32_t output_x,
        ...
        while (cnt) {
            ...
            if (mat_flag) {   
                ...
                if (double_flag == 1 && last_val != 0) {
                    ...
                    arm_nn_convolve_s8_single_sparse_CHW(conv_params,
                        in_ptr,
                        input_x, input_y,
                        output_x, output_y,
                        input_ch,
            ...
            if (double_flag && !(last_val == 0 && cur_val == 0)) {
                ...
                arm_nn_convolve_s8_double_sparse_CHW(conv_params,
                        in_ptr,
                        input_x, input_y,
                        output_x, output_y,
                        input_ch,
